...
<div align="right">
	...
	<form action="/perm/role/query" id="queryForm" name="queryForm" method="post">
...
<table border="1" cellspacing="1" cellpadding="0" width="900px">
	...
	<c:forEach items="${pageBean.data}" var="role" varStatus="i" step="1">
		<tr>
			...
			<td>${role.roleName}</td>
			<td align="center">
				<a href="/perm/role/manage?rid=${role.id}" >管理权限</a>
			</td>
		</tr>
	</c:forEach>
	<tr>
...
<form action="/perm/role/query" method="post" id="PageForm">
