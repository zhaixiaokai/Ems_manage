...
<BODY>
<h2>信件查询</h2>
<form action="/mail/query" id="queryForm" method="post">
<table>
	<tr>
		<td>发送时间段：</td>
	...
	<tr>
		<td>邮件名称：</td>
		<td><input type="text" name="mailName" id="mailName"></input></td>
	</tr>
	<tr>
		<td>企业名称：</td>
		<td>
...
<table border="1" cellspacing="1" cellpadding="0" width="900px">
	...
	<c:forEach items="${pageBean.data}" var="mail" varStatus="i" step="1">
		<tr>
			<td>${mail.mailName}</td>
...
<form action="/mail/query" method="post" id="PageForm">
	...
	<input type="hidden" value="${mailName}" name="mailName"/>
