...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#username").bind('blur',function(){
			...
			emsDwr.getUserNameNum($("#username").val(),function(num){
				if(num>0){
...
<BODY>
	<h2>添加用户信息：</h2>
	<form action="/user/addAction" id="loginform" name="loginform" method="post">
	<table>
		<tr>
			<td>用户名：</td>
			<td><input type="text" name="username" id="username" value=""/></td>	
			<td><div id="usernameinfo" class="red"></div></td>	
		</tr>
		<tr>
			<td>姓名：</td>
			<td><input type="text" name="name" id="name" value=""/></td>		
			<td><div id="nameinfo" class="red"></div></td>	
		</tr><!--
		<tr>
			<td>电子邮件：</td>
		...
		--><tr style="display: none;">
			<td>用户类型：</td>
			<td>
				<input type="radio" name="usertype" value="0" checked="checked">普通用户
				<input type="radio" name="usertype" value="1">管理员
			</td>
			<td><div id="usertypeinfo"></div></td>			
		</tr>
		<tr>
			<td></td>
			<td>
